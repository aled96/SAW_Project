...
function checkPassword(){
    var old_pass = document.getElementById("oldPassChange").value;
    var new_pass = document.getElementById("newPassChange").value;
    var repeat_new = document.getElementById("repeatNewPassChange").value;
    var checks = 0;
