            ...
            <div class="col-md-12 table-padding">
                        ...
                        <div class="list-category-column">
							...
							<?php
								...
								while($row = $result->fetch_assoc()) {	
									...
									echo'
									<li class="filter">'.$row['Name'].' ('.$row['NumCat'].')
										<div class="line-separator"></div>
									</li>';
								}
								?>
					...
					<div class="sw-search">
                        <div class="nav-search">
                            <span class="input-icon">
                                <input placeholder="Filter list ..." class="nav-search-input">
                        ...
                        <article class="price-range filter-table">
                            ...
                            <div class="content-filter-price">
                                <div class="col-md-4 inp-price data-price">
                                    <input type="text" id="first-range" name="minValue" placeholder="Min">
                                </div>
                                <div class="col-md-4 inp-price data-price">
                                    <input type="text" id="second-range" name="maxValue" placeholder="Max">
                                </div>
                                <div class="col-md-4 search-btn"><button type="button" class="btn default" tabindex="0"><span>Search</span></button></div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-md-9 panel">
                    ...
                    <div id="dataMix">
						...
						$sql = "SELECT *, book.ID as BookID FROM book,insertion WHERE book.ID = Material_offered ORDER BY Book.ID desc LIMIT 8";
						$result = $conn->query($sql);

						
						$cont = 0;
						//TODO -> va bene come metodo, ma se rimpicciolisci, il numero cambia (trovare soluzione)
						while($row = $result->fetch_assoc()) {
							if($cont == 4)
							{
								echo"</div><div id='dataMix'>";
								$cont = 0;
							}
							$cont++;
							#Check if logged
